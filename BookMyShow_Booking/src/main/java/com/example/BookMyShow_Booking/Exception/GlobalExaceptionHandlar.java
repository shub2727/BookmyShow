...
import com.example.BookMyShow_Booking.ApiConstant.ApiResponce;
...
public class GlobalExaceptionHandlar {
    ...
    @ExceptionHandler(SeatExtendLimt.class)
    ResponseEntity<ApiResponce> resourceNotFoundExceptionHandlar(SeatExtendLimt ex){
        String msg= ex.getMessage();
        ApiResponce apiRespones= ApiResponce.builder()
                .msg(msg)
                .build();
